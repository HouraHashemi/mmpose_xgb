...
def setup_3d_model(pose2d=None, pose2d_weights=None, pose3d='None', pose3d_weights=None,
                      det_model=None, det_weights=None, det_cat_ids=[0], device=None,
                      bbox_thr=0.3, nms_thr=0.3, pose_based_nms=False, kpt_thr=0.3,
                      tracking_thr=0.3, use_oks_tracking=False, disable_norm_pose_2d=False,
                      disable_rebase_keypoint=False, num_instances=1, radius=3, thickness=1,
                      skeleton_style='mmpose', black_background=False, vis_out_dir='',
                      pred_out_dir='', show=False, draw_bbox=False, draw_heatmap=False):
    ...
    call_args = {
        ...
        'use_oks_tracking': use_oks_tracking,
        'disable_norm_pose_2d': disable_norm_pose_2d,
        'disable_rebase_keypoint': disable_rebase_keypoint,
    ...
    return inferencer, call_args


def get_3d_prediction(frame, model, call_args):

    # Update the call arguments with the input frame
    call_args['inputs'] = frame

    # Perform inference
    frame_results = model(**call_args)
    for keypoint3d in frame_results:
        return keypoint3d
